            ...
            <table className="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="wd-login-id">001232162S</td>
                        <td className="wd-section">S101</td>
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-10-01</td>
                        <td className="wd-total-activity">11:32:33</td>
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                            <FaUserCircle className="me-2 fs-1 text-secondary" />
                    ...
                    <tr>
                        ...
                        <td className="wd-total-activity">13:24:34</td>
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                            <FaUserCircle className="me-2 fs-1 text-secondary" />
                    ...
                    <tr>
                        ...
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-12-01</td>
                        <td className="wd-total-activity">09:23:33</td>
                    </tr>
                </tbody>
            </table>
        </div>
